              ...
              <div style={{ position: 'relative' }} ref={dropdownRef}>
                ...
                {showSignIn && (
                  <div className="lp-signin-dropdown">
                    <h4 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, marginBottom: '1rem', fontSize: '1.1rem' }}>
                      Welcome back
                    </h4>
                    ...
                    <button
                      ...
                      style={{ width: '100%', padding: '0.65rem', fontSize: '0.9rem', marginBottom: '0.75rem' }}
                      onClick={handleLogin}
